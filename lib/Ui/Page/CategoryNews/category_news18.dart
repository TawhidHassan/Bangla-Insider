import 'package:banglainsider/Bloc/CategoryNews/category_news18_cubit.dart';
...
class CategoryNews18 extends StatefulWidget {
  int? menuId;
  int? lan;
  String? category;

  FooterContent?footerContent;
  CategoryNews18({this.menuId, this.lan,this.category,this.footerContent});

  @override
  _CategoryNews18State createState() => _CategoryNews18State();
}

class _CategoryNews18State extends State<CategoryNews18> {
  @override
  void initState() {
    // TODO: implement initState
    print("running cattt");
    BlocProvider.of<CategoryNews18Cubit>(context).categoryNewsData1(widget.menuId,widget.lan);
    super.initState();
  }
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<CategoryNews18Cubit, CategoryNews18State>(
      builder: (context, state) {
        if(state is !HomeCatnewsData18){
          return HomeCategoryShimer();
        }
        final data=(state as HomeCatnewsData18).categoryNewsResponse;
        return data!.data!.content!.isEmpty?Container(): Container(
          child: Column(
            children: [
              ...
              data.data!.feature_news ==null? Container(): NewsCardBigImagesortDetailsImageTop(cover: data.data!.feature_news,footerContent: widget.footerContent,),
