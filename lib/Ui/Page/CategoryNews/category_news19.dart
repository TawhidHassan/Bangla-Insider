...
import 'package:banglainsider/Bloc/CategoryNews/category_news19_cubit.dart';
...
class CategoryNews19 extends StatefulWidget {
  int? menuId;
  int? lan;
  String? category;

  FooterContent?footerContent;
  CategoryNews19({this.menuId, this.lan,this.category,this.footerContent});

  @override
  _CategoryNews19State createState() => _CategoryNews19State();
}

class _CategoryNews19State extends State<CategoryNews19> {
  @override
  void initState() {
    // TODO: implement initState
    print("running cattt");
    BlocProvider.of<CategoryNews19Cubit>(context).categoryNewsData1(widget.menuId,widget.lan);
    super.initState();
  }
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<CategoryNews19Cubit, CategoryNews19State>(
      builder: (context, state) {
        if(state is !HomeCatnewsData19){
          return HomeCategoryShimer();
        }
        final data=(state as HomeCatnewsData19).categoryNewsResponse;
