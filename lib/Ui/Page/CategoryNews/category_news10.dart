...
class CategoryNews10 extends StatefulWidget {
  int? menuId;
  int? lan;
  String? category;

  FooterContent?footerContent;
  CategoryNews10({this.menuId, this.lan,this.category,this.footerContent});

  @override
  _CategoryNews10State createState() => _CategoryNews10State();
}

class _CategoryNews10State extends State<CategoryNews10> {
  @override
  void initState() {
    // TODO: implement initState
    print("running cattt");
    BlocProvider.of<CategoryNews10Cubit>(context).categoryNewsData1(widget.menuId,widget.lan);
    super.initState();
  }
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<CategoryNews10Cubit, CategoryNews10State>(
      builder: (context, state) {
        if(state is !HomeCatnewsData10){
          return HomeCategoryShimer();
        }
        final data=(state as HomeCatnewsData10).categoryNewsResponse;
                ...
                child: Stack(
                  children: [
                    Container(
                      height: 200,
                      width: MediaQuery.of(context).size.width,
                      child: Image.network(BASE_URL_IMAGE+data.data!.feature_news!.media!.thumbnail.toString(),fit:BoxFit.cover),
                    ),
                    Positioned(
                        top: 100,
                        left: 0,
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                              ...
                              child: Text(data.data!.feature_news!.headline.toString(),style: TextStyle(fontSize: 19,fontWeight: FontWeight.bold,color: Colors.white),textAlign: TextAlign.start,)),
                        )
                    ),
                ...
                child: Stack(
                  children: [
                    Container(
                      height: 200,
                      width: MediaQuery.of(context).size.width,
                      child: Image.network(BASE_URL_IMAGE+data.data!.content![0].media!.thumbnail.toString(),fit:BoxFit.cover),
                    ),
                    Positioned(
                        top: 100,
                        left: 0,
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                              ...
                              child: Text(data.data!.content![0].headline.toString(),style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold,color: Colors.white),textAlign: TextAlign.start,)),
                        )
                    ),
                ...
                child: Stack(
                  children: [
                    Container(
                      height: 200,
                      width: MediaQuery.of(context).size.width,
                      child: Image.network(BASE_URL_IMAGE+data.data!.content![1].media!.thumbnail.toString(),fit:BoxFit.cover),
                    ),
                    Positioned(
                        top: 100,
                        left: 0,
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                              ...
                              child: Text(data.data!.content![1].headline.toString(),style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold,color: Colors.white),textAlign: TextAlign.start,)),
                        )
                    ),
              ...
              SizedBox(
                ...
                child:GridView.count(
                  ...
                  children: data.data!.content!.sublist(2,data.data!.content!.length).map((content) =>
                      InsiderMindNews(cover:content ,footerContent: widget.footerContent,)
                  ).toList(),
                ),
              ),
