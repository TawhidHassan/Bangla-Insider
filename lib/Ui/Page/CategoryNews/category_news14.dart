...
class CategoryNews14 extends StatefulWidget {
  int? menuId;
  int? lan;
  String? category;

  FooterContent?footerContent;
  CategoryNews14({this.menuId, this.lan,this.category,this.footerContent});

  @override
  _CategoryNews14State createState() => _CategoryNews14State();
}

class _CategoryNews14State extends State<CategoryNews14> {
  @override
  void initState() {
