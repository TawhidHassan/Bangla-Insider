...
class CategoryNews11 extends StatefulWidget {
  int? menuId;
  int? lan;
  String? category;

  FooterContent?footerContent;
  CategoryNews11({this.menuId, this.lan,this.category,this.footerContent});

  @override
  _CategoryNews11State createState() => _CategoryNews11State();
}

class _CategoryNews11State extends State<CategoryNews11> {
  @override
  void initState() {
    // TODO: implement initState
    BlocProvider.of<CategoryNews11Cubit>(context).categoryNewsData1(widget.menuId,widget.lan);
    super.initState();
  }
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<CategoryNews11Cubit, CategoryNews11State>(
      builder: (context, state) {
        if(state is !HomeCatnewsData11){
          return HomeCategoryShimer();
        }
        final data=(state as HomeCatnewsData11).categoryNewsResponse;
