...
class CategoryNews5 extends StatefulWidget {
  int? menuId;
  int? lan;
  String? category;
  FooterContent?footerContent;
  CategoryNews5({this.menuId, this.lan,this.category,this.footerContent});

  @override
  _CategoryNews5State createState() => _CategoryNews5State();
}

class _CategoryNews5State extends State<CategoryNews5> {
  @override
  void initState() {
    // TODO: implement initState
    print("running cattt");
    BlocProvider.of<CategoryNews5Cubit>(context).categoryNewsData1(widget.menuId,widget.lan);
    super.initState();
  }
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<CategoryNews5Cubit, CategoryNews5State>(
      builder: (context, state) {
        if(state is !HomeCatnewsData5){
          return HomeCategoryShimer();
        }
        final data=(state as HomeCatnewsData5).categoryNewsResponse;
