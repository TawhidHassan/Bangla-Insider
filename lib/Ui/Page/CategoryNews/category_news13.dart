...
import 'package:banglainsider/Bloc/CategoryNews/category_news13_cubit.dart';
...
class CategoryNews13 extends StatefulWidget {
  int? menuId;
  int? lan;
  String? category;

  FooterContent?footerContent;
  CategoryNews13({this.menuId, this.lan,this.category,this.footerContent});

  @override
  _CategoryNews13State createState() => _CategoryNews13State();
}

class _CategoryNews13State extends State<CategoryNews13> {
  @override
  void initState() {
    // TODO: implement initState
    BlocProvider.of<CategoryNews13Cubit>(context).categoryNewsData1(widget.menuId,widget.lan);
    super.initState();
  }
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<CategoryNews13Cubit, CategoryNews13State>(
      builder: (context, state) {
        if(state is !HomeCatnewsData13){
          return HomeCategoryShimer();
        }
        final data=(state as HomeCatnewsData13).categoryNewsResponse;
