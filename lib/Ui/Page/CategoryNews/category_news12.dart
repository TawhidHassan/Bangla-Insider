import 'package:banglainsider/Bloc/CategoryNews/category_news12_cubit.dart';
...
import 'package:banglainsider/Ui/Widgets/Card/NewsCardWithDetailsBig/news_card_big_image_With_Sortdeatils_image.dart';
...
class CategoryNews12 extends StatefulWidget {
  int? menuId;
  int? lan;
  String? category;

  FooterContent?footerContent;
  CategoryNews12({this.menuId, this.lan,this.category,this.footerContent});

  @override
  _CategoryNews12State createState() => _CategoryNews12State();
}

class _CategoryNews12State extends State<CategoryNews12> {
  @override
  void initState() {
    // TODO: implement initState
    print("running cattt");
    BlocProvider.of<CategoryNews12Cubit>(context).categoryNewsData1(widget.menuId,widget.lan);
    super.initState();
  }
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<CategoryNews12Cubit, CategoryNews12State>(
      builder: (context, state) {
        if(state is !HomeCatnewsData12){
          return HomeCategoryShimer();
        }
        final data=(state as HomeCatnewsData12).categoryNewsResponse;
              ...
              Container(
                child: Column(
                  children: data.data!.content!.map((content) =>
                      NewsCardBigImagesortDetailsImageTop(cover:content ,footerContent: widget.footerContent,)
