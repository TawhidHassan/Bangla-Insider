...
class CategoryNews6 extends StatefulWidget {
  int? menuId;
  int? lan;
  String? category;

  FooterContent?footerContent;
  CategoryNews6({this.menuId, this.lan,this.category,this.footerContent});

  @override
  _CategoryNews6State createState() => _CategoryNews6State();
}

class _CategoryNews6State extends State<CategoryNews6> {
  @override
  void initState() {
