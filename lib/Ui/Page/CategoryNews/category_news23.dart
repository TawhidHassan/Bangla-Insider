...
class CategoryNews23 extends StatefulWidget {
  int? menuId;
  int? lan;
  String? category;

  FooterContent?footerContent;
  CategoryNews23({this.menuId, this.lan,this.category,this.footerContent});

  @override
  _CategoryNews23State createState() => _CategoryNews23State();
}

class _CategoryNews23State extends State<CategoryNews23> {
  @override
  void initState() {
    // TODO: implement initState
    BlocProvider.of<CategoryNews23Cubit>(context).categoryNewsData1(widget.menuId,widget.lan);
    super.initState();
  }
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<CategoryNews23Cubit, CategoryNews23State>(
      builder: (context, state) {
        if(state is !HomeCatnewsData23){
          return HomeCategoryShimer();
        }
        final data=(state as HomeCatnewsData23).categoryNewsResponse;
