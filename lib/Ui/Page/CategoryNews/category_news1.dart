...
class CategoryNews1 extends StatefulWidget {
  int? menuId;
  int? lan;
  String? category;
...
class _CategoryNews1State extends State<CategoryNews1> {
  @override
  void initState() {
    // TODO: implement initState
    print("running cattt");
    BlocProvider.of<CategoryNewsCubit>(context).categoryNewsData1(widget.menuId,widget.lan);
    super.initState();
  }
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<CategoryNewsCubit, CategoryNewsState>(
      builder: (context, state) {
        if(state is !HomeCatnewsData1){
          return HomeCategoryShimer();
        }
        final data=(state as HomeCatnewsData1).categoryNewsResponse;
