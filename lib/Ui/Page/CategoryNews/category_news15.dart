...
class CategoryNews15 extends StatefulWidget {
  int? menuId;
  int? lan;
  String? category;

  FooterContent?footerContent;
  CategoryNews15({this.menuId, this.lan,this.category,this.footerContent});

  @override
  _CategoryNews15State createState() => _CategoryNews15State();
}

class _CategoryNews15State extends State<CategoryNews15> {
  @override
  void initState() {
    // TODO: implement initState
    BlocProvider.of<CategoryNews6Cubit>(context).categoryNewsData1(widget.menuId,widget.lan);
    super.initState();
  }
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<CategoryNews6Cubit, CategoryNews6State>(
      builder: (context, state) {
        if(state is !HomeCatnewsData6){
          return HomeCategoryShimer();
        }
        final data=(state as HomeCatnewsData6).categoryNewsResponse;
        return data!.data!.content!.isEmpty?Container(): Container(
          child: Column(
            children: [
              ...
              NewsCardBigImageDetailsImageTop(cover: data.data!.feature_news,footerContent: widget.footerContent,),
