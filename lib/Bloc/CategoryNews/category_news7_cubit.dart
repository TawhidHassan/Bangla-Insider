...
part 'category_news7_state.dart';

class CategoryNews7Cubit extends Cubit<CategoryNews7State> {


  CategoryNewsRepository categoryNewsRepository=CategoryNewsRepository();
  CategoryNews7Cubit() : super(CategoryNews7Initial());
  void categoryNewsData1(int? menuId, int? lan) {
    categoryNewsRepository.homeCategoryData(lan!,menuId!).then((result) => {
      if(result!=null){
        emit(HomeCatnewsData7(categoryNewsResponse:result))
      }
    });
  }
