...
part 'category_news19_state.dart';

class CategoryNews19Cubit extends Cubit<CategoryNews19State> {

  CategoryNewsRepository categoryNewsRepository=CategoryNewsRepository();
  CategoryNews19Cubit() : super(CategoryNews19Initial());
  void categoryNewsData1(int? menuId, int? lan) {
    categoryNewsRepository.homeCategoryData(lan!,menuId!).then((result) => {
      if(result!=null){
        emit(HomeCatnewsData19(categoryNewsResponse:result))
      }
    });
  }
}
