...
part 'category_news10_state.dart';

class CategoryNews10Cubit extends Cubit<CategoryNews10State> {

  CategoryNewsRepository categoryNewsRepository=CategoryNewsRepository();
  CategoryNews10Cubit() : super(CategoryNews10Initial());
  void categoryNewsData1(int? menuId, int? lan) {
    categoryNewsRepository.homeCategoryData(lan!,menuId!).then((result) => {
      if(result!=null){
        emit(HomeCatnewsData10(categoryNewsResponse:result))
      }
    });
  }
}
